...
- [x] Fix ms translation quality issues from code review: correct haribulan abbreviation (1hb), unambiguous days label (hari lalu), distinct ACCEPTED status (Disetujui vs Diterima) — done 2026-06-14
- [x] Fix react/no-unescaped-entities lint error in customers/[id]/page.tsx (apostrophe in JSX text) — done 2026-06-14
- [x] Fix onboarding test mock for new lucide-react icons added by pre-populated products feature (Stethoscope, ShoppingBag, Computer, Pill) — done 2026-06-14
- [x] Merge PR #265 (Bahasa Melayu localization) into main — done 2026-06-14
