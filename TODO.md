...
- [x] erp71.com VPS deployment — `docker-compose.erp71.yml` + `scripts/deploy-erp71.sh` for a second isolated instance (own DB `erp71_retail_saas`, `erp71` compose project, shared Postgres + hermes Caddy blocks for `app.`/`api.erp71.com`) — done 2026-06-29
