...
describe('PurchaseQuotationDetailPage', () => {
    ...
    it('navigates back on Back button click', async () => {
        ...
        expect(mockPush).toHaveBeenCalledWith('/dashboard/purchase-quotations');
    });
    ...
    it('converts RFQ to PO and navigates on confirm', async () => {
        ...
        await waitFor(() => {
            ...
            expect(mockPush).toHaveBeenCalledWith('/dashboard/purchase-orders/po-1');
        });
    ...
    it('shows CONVERTED status banner and navigates to purchase orders', async () => {
        ...
        expect(mockPush).toHaveBeenCalledWith('/dashboard/purchase-orders');
    });
